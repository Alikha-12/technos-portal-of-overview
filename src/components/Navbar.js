...

{
  ...
  >
    <div className="mx-auto max-w-screen-xl pl-4 sm:pl-6 lg:pl-8">
      <div className="flex h-16 items-center ">
        <div className="flex-1 md:flex md:items-center md:gap-12">
          <a
            className="block text-teal-600 justify-start text-left left-0"
            href="/"
          >
            <span className="sr-only">Home</span>
            <img className=" w-14 text-left  left-0" src={logo} />
            <path
