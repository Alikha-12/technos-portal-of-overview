...
function Vision() {
  return (
    <>
      ...
      />
      <header className="bg-indigo-200 pattern">
        <div className="container px-6 mx-auto">
          ...
          <div className="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
            <div className="w-full">
              ...
              <p className="mt-4 text-gray-100 text-2">
            ...
            <div className="flex mt-8 lg:w-full lg:justify-end lg:mt-0">
              <div className="w-full max-w-md bg-white rounded-lg dark:bg-gray-800"></div>
            </div>
            {/* START HERE */}
            {/* <a href="#" className="block group pr-64">
              <img
                src={Class}
                alt=""
                className="h-full w-screens object-cover sm:h-[450px] rounded-md"
              />
            </a> */}
          </div>
        </div>
