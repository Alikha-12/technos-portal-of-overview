...
function Hero() {
  return (
    <div
      className=" bg-cover text-center font-Bebas pt-64 tracking-wider font-medium text-whitez text-6xl bg-fixed bg-center "
      style={{
        backgroundImage: `url(${frontview})`,
      }}
    >
      {" "}
      <h1 className=" text-white text-opacity-95 text-6xl pt-80 text-right pr-5 pb-80">
