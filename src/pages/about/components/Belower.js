      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-2 text-blue-500 ">smptechnoinsankamil@gmail.com</p>
          </div>
          <div>
            <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 ">
              <svg
            ...
            <p className="mt-2 text-blue-500 dark:text-blue-400">
              Jl Al Falah II Kec Tuban Kab Tuban Jawa Timur Indonesia
            </p>
          </div>
          <div>
            <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 ">
            ...
            <p className="mt-2 text-gray-500 ">Mon-Fri from 8am to 4pm.</p>
            <p className="mt-2 text-blue-500">+62 0356 333280</p>
          </div>
        </div>
      </div>
    </section>
